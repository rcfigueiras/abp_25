			...
			<?PHP
				foreach  ($_SESSION['pinchos'] as $valor){
					if($valor['nombre_pincho'] == $_SESSION['nombrePin']){
						...
						<?PHP echo "<br>"; ?>
						<?PHP echo "Nota: "?><input TYPE=text NAME="nota" VALUE="<?PHP echo $_SESSION['nota']?>"readonly>	
						<?PHP echo "<br>"; ?>
						<?PHP echo "Comentario"?><input TYPE=text NAME="comentario" VALUE="<?PHP echo $_SESSION['comentario']?>"readonly>							
						<?PHP echo "<br>"; ?>
						<?PHP echo "Nueva nota"?><input TYPE=text NAME="newNota" VALUE="nueva nota">							
						<?PHP echo "<br>"; ?>
						<?PHP echo "Nuevo comentario"?><input TYPE=text NAME="newComentario" VALUE="nuevo comentario">							
				...
				?>			
			<td >
				<INPUT  TYPE="submit" NAME="accion" VALUE="modificaValoracion" >
