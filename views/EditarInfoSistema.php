  ...
  <div class="page-container">
   ...
   <!-- For alternative headers START PASTE here -->
    ...
    <form action="/controllers/administrador_controlador.php" method="post"> 
		<table>
			<tr>
			<td  width="250" align="right">*Nombre del concurso:<td/> 
			<td width="250" ><input type=text NAME="nombreConcNew" value="<?PHP echo $_SESSION['nombre_consurso']?>" ><td/>
			<tr/>
			...
			<tr>
			<td width="250" align="right">*Bases:<td/> <td width="250" >
			<input type=text NAME="basesConcNew" value="<?PHP echo $_SESSION['bases']?>" ><td/>
			<tr/>
			
			<tr>
			<td width="250" align="right">*Logotipo:<td/> <td width="250" >
			<input type=text NAME="logoConcNew" value="<?PHP echo $_SESSION['logotipo']?>" ><td/>
			<tr/>
