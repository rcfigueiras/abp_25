			...
			<?PHP
				foreach  ($_SESSION['pinchos'] as $valor){
					if($valor['nombre_pincho'] == $_SESSION['nombrePin']){
						...
						<?PHP echo "<br>"; ?>
						<?PHP echo "Nota: "?><input TYPE=text NAME="nota" VALUE="su nota">	
						<?PHP echo "<br>"; ?>
						<?PHP echo "Comentario"?><input TYPE=text NAME="comentario" VALUE="su comentario">							
				...
				?>			
			<td >
				<INPUT  TYPE="submit" NAME="accion" VALUE="valoraYa" >
